<?php
//============================================================+
// File name   : etldevtcpdf_parser.php
// Version     : 1.0.16
// Begin       : 2011-05-23
// Last Update : 2015-04-28
// Author      : Nicola Asuni - Tecnick.com LTD - www.tecnick.com - info@tecnick.com
// License     : http://www.tecnick.com/pagefiles/etldevtcpdf/LICENSE.TXT GNU-LGPLv3
// -------------------------------------------------------------------
...
require_once(dirname(__FILE__).'/include/etldevtcpdf_filters.php');

/**
 * @class ETLDEVTCPDF_PARSER
 * This is a PHP class for parsing PDF documents.<br>
 * @package com.tecnick.etldevtcpdf
...
// -----------------------------------------------------------------------------
	...
	protected function decodeStream($sdic, $stream) {
		...
		foreach ($filters as $filter) {
			if (in_array($filter, ETLDEVTCPDF_FILTERS::getAvailableFilters())) {
				try {
					$stream = ETLDEVTCPDF_FILTERS::decodeFilter($filter, $stream);
				} catch (Exception $e) {
					$emsg = $e->getMessage();
	...
	public function Error($msg) {
		if ($this->cfg['die_for_errors']) {
			die('<strong>ETLDEVTCPDF_PARSER ERROR: </strong>'.$msg);
		} else {
			throw new Exception('ETLDEVTCPDF_PARSER ERROR: '.$msg);
		}
	}

} // END OF ETLDEVTCPDF_PARSER CLASS
