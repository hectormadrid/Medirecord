...
//
// Description : Example 016 for ETLDEVTCPDF class
 ...
 * @abstract ETLDEVTCPDF - Example: Document Encryption / Security
 * @author Nicola Asuni
 * @since 2008-03-04
 */
...
// To open the document you need to install the private key (etldevtcpdf.p12) on the Acrobat Reader. The password is: 1234
//$pdf->SetProtection($permissions=array('print', 'copy'), $user_pass='', $owner_pass=null, $mode=1, $pubkeys=array(array('c' => 'file://../config/cert/etldevtcpdf.crt', 'p' => array('print'))));
...
$pdf->SetTitle('ETLDEVTCPDF Example 016');
