...
//
// Description : Example 043 for ETLDEVTCPDF class
//               Disk caching
//
// Author: Nicola Asuni
//
 ...
 * @abstract ETLDEVTCPDF - Example: Disk caching
 * @author Nicola Asuni
 * @since 2009-01-02
 */
...
$pdf = new ETLDEVTCPDF(PDF_PAGE_ORIENTATION, PDF_UNIT, PDF_PAGE_FORMAT, true, 'UTF-8', true);

// set document information
$pdf->SetCreator(PDF_CREATOR);
$pdf->SetAuthor('Nicola Asuni');
$pdf->SetTitle('ETLDEVTCPDF Example 043');
