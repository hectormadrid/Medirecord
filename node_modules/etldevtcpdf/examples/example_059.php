...
//
// Description : Example 059 for ETLDEVTCPDF class
 ...
 * @abstract ETLDEVTCPDF - Example: Table Of Content using HTML templates.
 * @author Nicola Asuni
 * @since 2010-05-06
 */
...
/**
 * ETLDEVTCPDF class extension with custom header and footer for TOC page
 */
class TOC_TCPDF extends ETLDEVTCPDF {
...
$pdf->SetTitle('ETLDEVTCPDF Example 059');
