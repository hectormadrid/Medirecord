...
//
// Description : Example 050 for ETLDEVTCPDF class
//               2D Barcodes
//
// Author: Nicola Asuni
//
 ...
 * @abstract ETLDEVTCPDF - Example: 2D barcodes.
 * @author Nicola Asuni
 * @since 2008-03-04
 */
...
$pdf->SetTitle('ETLDEVTCPDF Example 050');
...
$pdf->write2DBarcode('www.etldevtcpdf.org', 'QRCODE,L', 20, 30, 50, 50, $style, 'N');
$pdf->Text(20, 25, 'QRCODE L');

// QRCODE,M : QR-CODE Medium error correction
$pdf->write2DBarcode('www.etldevtcpdf.org', 'QRCODE,M', 20, 90, 50, 50, $style, 'N');
$pdf->Text(20, 85, 'QRCODE M');

// QRCODE,Q : QR-CODE Better error correction
$pdf->write2DBarcode('www.etldevtcpdf.org', 'QRCODE,Q', 20, 150, 50, 50, $style, 'N');
$pdf->Text(20, 145, 'QRCODE Q');

// QRCODE,H : QR-CODE Best error correction
$pdf->write2DBarcode('www.etldevtcpdf.org', 'QRCODE,H', 20, 210, 50, 50, $style, 'N');
...
$pdf->write2DBarcode('www.etldevtcpdf.org', 'PDF417', 80, 90, 0, 30, $style, 'N');
$pdf->Text(80, 85, 'PDF417 (ISO/IEC 15438:2006)');

// -------------------------------------------------------------------
// DATAMATRIX (ISO/IEC 16022:2006)

$pdf->write2DBarcode('http://www.etldevtcpdf.org', 'DATAMATRIX', 80, 150, 50, 50, $style, 'N');
...
// QRCODE,H : QR-CODE Best error correction
$pdf->write2DBarcode('www.etldevtcpdf.org', 'QRCODE,H', 80, 210, 50, 50, $style, 'N');
...
// QRCODE,H : QR-CODE Best error correction
$pdf->write2DBarcode('www.etldevtcpdf.org', 'QRCODE,H', 140, 210, 50, 50, $style, 'N');
