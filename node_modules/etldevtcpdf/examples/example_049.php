...
//
// Description : Example 049 for ETLDEVTCPDF class
//               WriteHTML with ETLDEVTCPDF callback functions
//
// Author: Nicola Asuni
//
// (c) Copyright:
 ...
 * @abstract ETLDEVTCPDF - Example: WriteHTML with ETLDEVTCPDF callback functions
 * @author Nicola Asuni
 * @since 2008-03-04
 */
...
$pdf->SetTitle('ETLDEVTCPDF Example 049');
...
IMPORTANT:
If you are printing user-generated content, etldevtcpdf tag can be unsafe.
You can disable this tag by setting to false the K_ETLDEVTCPDF_CALLS_IN_HTML
constant on ETLDEVTCPDF configuration file.

For security reasons, the parameters for the 'params' attribute of ETLDEVTCPDF
...
$html = '<h1>Test ETLDEVTCPDF Methods in HTML</h1>
<h2 style="color:red;">IMPORTANT:</h2>
<span style="color:red;">If you are using user-generated content, the etldevtcpdf tag can be unsafe.<br />
You can disable this tag by setting to false the <b>K_ETLDEVTCPDF_CALLS_IN_HTML</b> constant on ETLDEVTCPDF configuration file.</span>
...
$html .= '<etldevtcpdf method="write1DBarcode" params="'.$params.'" />';
...
$html .= '<etldevtcpdf method="AddPage" /><h2>Graphic Functions</h2>';

$params = $pdf->serializeTCPDFtagParameters(array(0));
$html .= '<etldevtcpdf method="SetDrawColor" params="'.$params.'" />';

$params = $pdf->serializeTCPDFtagParameters(array(50, 50, 40, 10, 'DF', array(), array(0,128,255)));
$html .= '<etldevtcpdf method="Rect" params="'.$params.'" />';
