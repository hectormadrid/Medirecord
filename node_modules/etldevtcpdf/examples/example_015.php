...
//
// Description : Example 015 for ETLDEVTCPDF class
 ...
 * @abstract ETLDEVTCPDF - Example: Bookmarks (Table of Content)
 * @author Nicola Asuni
 * @since 2008-03-04
 */
...
$pdf->SetTitle('ETLDEVTCPDF Example 015');
...
$pdf->Bookmark('External URL', 0, 0, '', 'B', array(0,0,255), -1, 'http://www.etldevtcpdf.org');
