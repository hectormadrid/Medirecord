...
//
// Description : Example 019 for ETLDEVTCPDF class
 ...
 * @abstract ETLDEVTCPDF - Example: Non unicode with alternative config file
 * @author Nicola Asuni
 * @since 2008-03-04
 */
...
$pdf = new ETLDEVTCPDF(PDF_PAGE_ORIENTATION, PDF_UNIT, PDF_PAGE_FORMAT, false, 'ISO-8859-1', false);
...
$pdf->SetTitle('ETLDEVTCPDF Example 019');
...
Check the definition of the K_ETLDEVTCPDF_EXTERNAL_CONFIG constant on the source code.';
