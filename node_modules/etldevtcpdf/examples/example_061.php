...
//
// Description : Example 061 for ETLDEVTCPDF class
//               XHTML + CSS
//
// Author: Nicola Asuni
//
 ...
 * @abstract ETLDEVTCPDF - Example: XHTML + CSS
 * @author Nicola Asuni
 * @since 2010-05-25
 */
...
$pdf->SetTitle('ETLDEVTCPDF Example 061');
...
Since the CSS margin command is not yet implemented on ETLDEVTCPDF, you need to set the spacing of block tags using the following method.
