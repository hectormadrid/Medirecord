...
//
// Description : Example 058 for ETLDEVTCPDF class
//               SVG Image
//
// Author: Nicola Asuni
//
 ...
 * @abstract ETLDEVTCPDF - Example: SVG Image
 * @author Nicola Asuni
 * @since 2010-05-02
 */
...
$pdf->SetTitle('ETLDEVTCPDF Example 058');
...
$pdf->ImageSVG($file='images/testsvg.svg', $x=15, $y=30, $w='', $h='', $link='http://www.etldevtcpdf.org', $align='', $palign='', $border=1, $fitonpage=false);
