...
//
// Description : Example 055 for ETLDEVTCPDF class
 ...
 * @abstract ETLDEVTCPDF - Example: XHTML Forms
 * @author Nicola Asuni
 * @since 2009-10-21
 */
...
$pdf->SetTitle('ETLDEVTCPDF Example 055');
...
foreach($core_fonts as $font) {
	...
	for ($i = 0; $i < 256; ++$i) {
		...
		$pdf->Cell(11.25, 11.25, ETLDEVTCPDF_FONTS::unichr($i), 1, 0, 'C', false, '', 0, false, 'T', 'M');
	}
