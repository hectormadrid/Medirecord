...
//
// Description : Example 042 for ETLDEVTCPDF class
 ...
 * @abstract ETLDEVTCPDF - Example: Test Image with alpha channel
 * @author Nicola Asuni
 * @since 2008-12-23
 */
...
$pdf->SetTitle('ETLDEVTCPDF Example 042');
...
$background_text = str_repeat('ETLDEVTCPDF test PNG Alpha Channel ', 50);
...
$pdf->Image('images/image_with_alpha.png', 50, 50, 100, '', '', 'http://www.etldevtcpdf.org', '', false, 300);
...
$pdf->Image('images/img.png', 50, 140, 100, '', '', 'http://www.etldevtcpdf.org', '', false, 300, '', false, $mask);
