...
// -------------------------------------------------------------------
//
// Description : Example for etldevtcpdf_barcodes_2d.php class
//
//============================================================+

/**
 * @file
 * Example for etldevtcpdf_barcodes_2d.php class
...
require_once(dirname(__FILE__).'/etldevtcpdf_barcodes_2d_include.php');

// set the barcode content and type
$barcodeobj = new TCPDF2DBarcode('http://www.etldevtcpdf.org', 'DATAMATRIX');
