<?php
//============================================================+
// File name   : etldevtcpdf_barcodes_1d.php
// Version     : 1.0.027
// Begin       : 2008-06-09
...
//               common 1D barcodes to be used with ETLDEVTCPDF.
//
//============================================================+

/**
 * @file
 * PHP class to creates array representations for common 1D barcodes to be used with ETLDEVTCPDF.
...
/**
 * @class TCPDFBarcode
 * PHP class to creates array representations for common 1D barcodes to be used with ETLDEVTCPDF (http://www.etldevtcpdf.org).<br>
 * @package com.tecnick.etldevtcpdf
 * @version 1.0.027
 * @author Nicola Asuni
 */
class TCPDFBarcode {
	...
	/**
	 * Convert binary barcode sequence to ETLDEVTCPDF barcode array.
	 * @param $seq (string) barcode as binary sequence.
	 * @param $bararray (array) barcode array.
	 * òparam array $bararray ETLDEVTCPDF barcode array to fill up
	 * @return array barcode representation.
	 * @protected
	 */
