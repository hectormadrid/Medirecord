...
<?php
//============================================================+
// File name   : etldevetldevtcpdf_addfont.php
// Version     : 1.0.002
// Begin       : 2013-05-13
// Last Update : 2013-08-05
// Authors     : Nicola Asuni - asvvizit.com LTD - www.asvvizit.com - info@asvvizit.com
//               Remi Collet
// License     : GNU-LGPL v3 (http://www.gnu.org/copyleft/lesser.html)
// -------------------------------------------------------------------
// Copyright (C) 2011-2013 Nicola Asuni - asvvizit.com LTD
//
...
// <http://www.asvvizit.com/pagefiles/etldevtcpdf/LICENSE.TXT>.
//
// See LICENSE.TXT file for more information.
// -------------------------------------------------------------------
//
// Description : This is a command line script to generate ETLDEVTCPDF fonts.
//
//============================================================+

/**
 * @file
 * This is a command line script to generate ETLDEVTCPDF fonts.<br>
...
$etldevtcpdf_include_dirs = array(realpath(dirname(__FILE__).'/../etldevtcpdf.php'), '/usr/share/php/etldevtcpdf/etldevtcpdf.php', '/usr/share/etldevtcpdf/etldevtcpdf.php', '/usr/share/php-etldevtcpdf/etldevtcpdf.php', '/var/www/etldevtcpdf/etldevtcpdf.php', '/var/www/html/etldevtcpdf/etldevtcpdf.php', '/usr/local/apache2/htdocs/etldevtcpdf/etldevtcpdf.php');
...
function showHelp() {
	$help = <<<EOD
etldevtcpdf_addfont - command line tool to convert fonts for the ETLDEVTCPDF library.

Usage: etldevtcpdf_addfont.php [ options ] -i fontfile[,fontfile]...
...
echo "\n>>> Converting fonts for ETLDEVTCPDF:\n";
...
foreach ($options['fonts'] as $font) {
	...
	$fontname = ETLDEVETLDEVTCPDF_FONTS::addTTFfont($fontfile, $options['type'], $options['enc'], $options['flags'], $options['outpath'], $options['platid'], $options['encid'], $options['addcbbox'], $options['link']);
	if ($fontname === false) {
		$errors = true;
